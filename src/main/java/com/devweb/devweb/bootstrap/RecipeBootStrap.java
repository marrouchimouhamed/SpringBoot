package com.devweb.devweb.bootstrap;

import com.devweb.devweb.domain.*;
import com.devweb.devweb.repositories.CategoryRepository;
import com.devweb.devweb.repositories.RecipeRepository;
import com.devweb.devweb.repositories.UnitMeasureRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitMeasure> eachUomOptional = unitOfMeasureRepository.findByDescription("metre");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("pound");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("inch");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("kilo");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
